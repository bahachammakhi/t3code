...
The tunnel fabric can later be Pipenet-derived, Tailscale-derived, or another reverse tunnel implementation. The rest of B3 Code should only see an `AdvertisedEndpoint`.
