...
T3CODE_PORT=13773 \
  "/Applications/B3 Code (Alpha).app/Contents/MacOS/B3 Code (Alpha)"
```
...
```sh
codesign --verify --deep --strict "/Applications/B3 Code (Alpha).app"
codesign -d --entitlements :- "/Applications/B3 Code (Alpha).app"
```
