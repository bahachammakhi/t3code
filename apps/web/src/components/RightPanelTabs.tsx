...
const SURFACE_DISABLED_REASONS = {
  browser: "Browser previews are only available in the B3 Code desktop app.",
...
function surfaceTitle(
  ...
  switch (surface.kind) {
    ...
    case "plan":
      return "Plan";
    case "subagent":
      return `Subagent · ${String(surface.threadId).slice(-8)}`;
    case "preview": {
...
function SurfaceIcon({
  ...
  switch (surface.kind) {
    ...
    case "subagent":
      return <WaypointsIcon className="size-3.5 shrink-0 text-[#d4af37] dark:text-[#ffd700]" />;
  }
}
