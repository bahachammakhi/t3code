  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new B3 Code prerelease is available for nightly testers."
          : "A new B3 Code latest release is available.",
...
).pipe(Command.withDescription("Post a B3 Code release announcement to Discord."));
